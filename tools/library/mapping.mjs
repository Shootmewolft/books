export const DUPLICATES = [
  ...
  },
  {
    ...
    drop: [
      'Software Engineering/Design Patterns Elements of Reusable Object-Oriented Software.pdf',
    ],
  },
  {
  ...
  },
  {
    ...
    drop: [
      'programming/The Art of Unit Testing, with examples in C_ (2014, Manning) - Roy Osherove.pdf',
    ],
  },
  {
  ...
  },
  {
    ...
    drop: [
      'Databases/design/(Wrox beginning guides) Rod Stephens - Beginning database design solutions-Wiley Pub (2009).pdf',
    ],
  },
  {
...
export const DIRECTORY_RULES = [
  ...
  [
    'Operating Systems/',
    { category: 'foundations', subcategory: 'operating-systems', tags: ['unix'] },
  ],
  [
    'networking/mqtt/',
    { category: 'foundations', subcategory: 'networking', tags: ['mqtt', 'messaging'] },
  ],
  ['networking/', { category: 'foundations', subcategory: 'networking', tags: [] }],
  [
    'programming/concurrency/',
    { category: 'foundations', subcategory: 'concurrency', tags: ['concurrency'] },
  ],

  [
    'programming/clean-code/',
    { category: 'programming', subcategory: 'code-quality', tags: ['refactoring'] },
  ],
  [
  ...
  [
    ...
    { category: 'programming', subcategory: 'design-patterns', tags: ['design-patterns', 'oop'] },
  ],
  [
  ...
  [
    'programming/spring/',
    { category: 'programming', subcategory: 'spring', tags: ['spring', 'java'] },
  ],
  ['programming/tools/', { category: 'programming', subcategory: 'tooling', tags: ['git'] }],

  [
    'Software Architecture/DDD/',
    { category: 'architecture', subcategory: 'domain-driven-design', tags: ['ddd'] },
  ],
  [
    'Software Architecture/microservices/',
    { category: 'architecture', subcategory: 'microservices', tags: ['microservices'] },
  ],
  ...
  [
    'Distributed Systems/',
    { category: 'architecture', subcategory: 'distributed-systems', tags: ['distributed-systems'] },
  ],
  ...
  [
    ...
    { category: 'data', subcategory: 'elasticsearch', tags: ['nosql', 'indexing'] },
  ],
  ...
  [
    'devops/container/',
    { category: 'platform', subcategory: 'containers', tags: ['docker', 'containers'] },
  ],
  [
    'devops/k8s/',
    { category: 'platform', subcategory: 'kubernetes', tags: ['kubernetes', 'cloud-native'] },
  ],
  ['devops/', { category: 'platform', subcategory: 'devops', tags: ['devops'] }],

  [
    'Software Testing/load-testing/',
    { category: 'quality', subcategory: 'load-testing', tags: ['testing', 'performance'] },
  ],
  [
    'Software Testing/unit-test/',
    { category: 'quality', subcategory: 'unit-testing', tags: ['testing', 'tdd'] },
  ],
  ...
  [
    'Problem Solving/System Design Interview/',
    { category: 'craft', subcategory: 'interviews', tags: ['interviews', 'system-design'] },
  ],
  ['Problem Solving/', { category: 'craft', subcategory: 'engineering-practice', tags: [] }],
  [
    'Machine Learning/',
    { category: 'craft', subcategory: 'interviews', tags: ['interviews', 'machine-learning'] },
  ],

  [
    'Soft Skills/negotiating/',
    { category: 'career', subcategory: 'negotiation', tags: ['negotiation'] },
  ],
...
export const OVERRIDES = {
  ...
  'programming/Concurrent Programming in Java Design Principles.pdf': {
    ...
    subtitle: 'Design Principles and Patterns',
    authors: ['Doug Lea'],
    tags: ['concurrency', 'java', 'jvm'],
  },
  ...
  'System Design/Chris Richardson - Microservices Patterns_ With examples in Java (2018, Manning Publications).pdf':
    {
      ...
      tags: ['microservices', 'java', 'design-patterns'],
    },
  ...
  'Software Architecture/Designing_Event_Driven_Systems.pdf': {
    ...
    publisher: "O'Reilly Media",
    year: 2018,
    tags: ['event-driven', 'kafka', 'streaming'],
  },
  ...
  'Software Architecture/microservices/MicroservicePatternLanguage.pdf': {
    ...
    subcategory: 'microservices',
    kind: 'reference',
    title: 'Microservice Pattern Language',
  ...
  'programming/clean-code/clean-code-tips-tricks-world-coding.pdf': {
    ...
    subcategory: 'code-quality',
    kind: 'guide',
    title: 'Clean Code Tips and Tricks',
    tags: ['refactoring'],
  },
  ...
  'Apache Kafka/Kafka-Optimization-Benchmarking-Guide.pdf': {
    ...
    subcategory: 'kafka',
    kind: 'guide',
    title: 'Kafka Optimization and Benchmarking Guide',
  ...
  'Apache Kafka/Optimizing_Your_Apache_Kafka_Deployment.pdf': {
    ...
    subcategory: 'kafka',
    kind: 'guide',
    title: 'Optimizing Your Apache Kafka Deployment',
    tags: ['kafka', 'performance'],
  },
  ...
  'Databases/postgresql/Effective_Indexing_in_Postgres.pdf': {
    ...
    kind: 'guide',
    title: 'Effective Indexing in Postgres',
  ...
  'Databases/redis/caching-at-scale-with-redis-updated-2021-12-04.pdf': {
    ...
    year: 2021,
    tags: ['caching', 'nosql', 'scalability'],
  },
  ...
  'Soft Skills/negotiating/EssentialInsight Summaries - Summary_ Never Split the Difference_ Negotiating As If Your Life Depended On It - by Chris Voss (2021, EssentialInsight Summaries) - libgen.li.pdf':
    {
      ...
      kind: 'guide',
      title: 'Summary: Never Split the Difference',
      authors: ['EssentialInsight Summaries'],
      year: 2021,
      tags: ['negotiation'],
    },
